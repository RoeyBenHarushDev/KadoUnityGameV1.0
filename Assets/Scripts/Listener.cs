...
namespace AssemblyCSharp
{
	...
	{						
		...
		int state = 0;
        public static int currentPlayers = 0;  // מספר השחקנים בחדר
        ...
        public void onGetLiveRoomInfoDone(LiveRoomInfoEvent eventObj)
        {
            ...
            {
                currentPlayers = eventObj.getJoinedUsers().Length;
                Debug.Log("Current number of players in room: " + currentPlayers);
            }
            else
            {
                Debug.LogError("Failed to retrieve live room info.");
            }
        }
